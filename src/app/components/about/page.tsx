    ...
    <main className="grid grid-cols-1">
      <div className="md:flex grid grid-cols-1">
        <div className="ml-[100px]">
          ...
          <button className="w-[200px] h-[48px] text-white font-semibold bg-sky-500 rounded-sm mt-7 flex items-center justify-center">Get Qoute Now</button>
        </div>

        <div className="md:w-[484px] md:h-[484px] w-[200px] h-[200px] bg-red-100 rounded-full md:ml-[500px] ml-[100px] mt-9">
          <Image src="/aboutgirl.png" alt="About Girl" className="md:w-[571px] w-[171px] md:h-[668px] h-[268px] md:pb-16" width={571} height={668} />
        </div>
      </div>
      ...
      <div className="mt-44 flex items-center justify-center relative">
        <Image src="/scene.jpeg" alt="Scene Image" className="w-[989px] h-[540px] rounded-lg" width={989} height={540} />
      ...
      <div className="md:flex items-center justify-evenly mt-20 mb-44 grid grid-cols-1 ml-10">
        <div>
          <Image src="/abt1.jpeg" alt="Team Member 1" className="w-[316px] h-[231px]" width={316} height={231} />
        ...
        <div>
          <Image src="/abt2.jpeg" alt="Team Member 2" className="w-[316px] h-[231px]" width={316} height={231} />
          <h1 className="text-blue-950 font-semibold text-center mt-5">Username</h1>
          <p className="text-gray-500 text-center mt-2">Profession</p>
          <div className="flex space-x-2 text-sky-500 mt-2 items-center justify-center">
            <FaInstagram className="w-7 h-7" />
        ...
        <div>
          <Image src="/abt3.jpeg" alt="Team Member 3" className="w-[316px] h-[231px]" width={316} height={231} />
          <h1 className="text-blue-950 font-semibold text-center mt-5">Username</h1>
          <p className="text-gray-500 text-center mt-2">Profession</p>
          <div className="flex space-x-2 text-sky-500 mt-2 items-center justify-center">
            <FaInstagram className="w-7 h-7" />
      ...
      <div className="bg-gray-50 py-20">
        <h1 className="text-blue-950 font-semibold text-center md:text-4xl text-3xl">Big Companies are here</h1>
        <p className="text-center text-gray-500 font-semibold mt-4">
          Problems trying to resolve the conflict between<br />the two realms of Classical physics: Newtonian mechanics
        </p>

        <div className="md:grid md:grid-cols-5 grid grid-cols-1 md:gap-3 gap-8 mt-20 ml-[130px]">
          <Image src="/fa-brands-1.png" alt="Brand 1" className="w-[153px] h-[34px]" width={153} height={34} />
          <Image src="/fa-brands-2.png" alt="Brand 2" className="w-[146px] h-[59px]" width={146} height={59} />
          <Image src="/fa-brands-3.png" alt="Brand 3" className="w-[152px] h-[75px]" width={152} height={75} />
          <Image src="/fa-brands-4.png" alt="Brand 4" className="w-[151px] h-[42px]" width={151} height={42} />
          <Image src="/fa-brands-5.png" alt="Brand 5" className="w-[151] h-[62px]" width={151} height={62} />
        </div>
      </div>
      ...
      <div className="md:grid md:grid-cols-3 md:w-full md:ml-[100px] md:mb-20">
        ...
        <Image src="/pinkgirl.jpeg" alt="Pink Girl Image" className="md:w-full md:h-full" width={1440} height={636} />
      </div>
    </main>
  );
}
