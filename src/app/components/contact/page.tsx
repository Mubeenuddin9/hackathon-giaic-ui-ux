  ...
  return (
    <div className="bg-white">
      ...
      <div className="mt-32">
        ...
        <h1 className="text-blue-950 font-semibold flex justify-center items-center text-3xl text-center mt-4">
        ...
        <div className="md:flex md:ml-52 mt-14">
          <div className="bg-white w-[327px] h-[403px]">
            ...
            <p className="text-black font-semibold text-center mt-4">
              georgia.young@exapmle.com<br />georgia.young@ple.com
            </p>

            <h1 className="text-black text-lg font-semibold mt-4 ml-[100px]">Get Support</h1>

            <button className="bg-white text-sky-500 font-semibold border border-sky-500 w-[200px] h-[52px] ml-[50px] mt-6 rounded-full">
              Submit Request
            </button>
          </div>
          ...
          <div className="bg-blue-950 w-[327px] h-[403px]">
            ...
            <button className="bg-blue-950 text-sky-500 font-semibold border border-sky-500 w-[200px] h-[52px] ml-[60px] mt-6 rounded-full">
              Submit Request
            </button>
          </div>
          ...
          <div className="bg-white w-[327px] h-[403px]">
            ...
            <button className="bg-white text-sky-500 font-semibold border border-sky-500 w-[200px] h-[52px] ml-[60px] mt-6 rounded-full">
              Submit Request
            </button>
          </div>
        </div>
      ...
      <div className="mt-24">
        ...
        <button className="bg-sky-500 text-white font-semibold flex items-center justify-center w-[200px] h-[52px] md:ml-[620px] mt-6 rounded-md">
          Try for free now
        </button>
      </div>
    </div>
